...
const containerTypes = [
  ...
  { name: "20' Rabljen", dimensions: '6,06 m x 2,44 m x 2,89 m', condition: 'Second Trip', availability: 'Na zalogi', floorArea: '14,8 m\u00B2', volume: '37,4 m\u00B3', price: '1.490', color: '/', imagePath: rabljen20, fallbackImage: 'https://images.pexels.com/photos/163726/belgium-antwerp-shipping-container-163726.jpeg?auto=compress&cs=tinysrgb&w=800' },
  { name: "40' Rabljen", dimensions: '12,19 m x 2,44 m x 2,89 m', condition: 'Rabljeno', availability: 'Na zalogi', floorArea: '29,7 m\u00B2', volume: '76,3 m\u00B3', price: '1.990', color: '/', imagePath: rabljen40, fallbackImage: 'https://images.pexels.com/photos/163726/belgium-antwerp-shipping-container-163726.jpeg?auto=compress&cs=tinysrgb&w=800' },
