...
interface LadijskiKontejnerjiPageProps {
...
const containerTypes = [
  ...
  { name: "20' Rabljen", dimensions: '6,06 m x 2,44 m x 2,59 m', condition: 'Second Trip', availability: 'Na zalogi', floorArea: '14,8 m\u00B2', volume: '33,2 m\u00B3', price: '1.490', color: '/', imagePath: rabljen20, fallbackImage: 'https://images.pexels.com/photos/163726/belgium-antwerp-shipping-container-163726.jpeg?auto=compress&cs=tinysrgb&w=800' },
...
const LadijskiKontejnerjiPage: React.FC<LadijskiKontejnerjiPageProps> = ({ onPageChange }) => {
      ...
      <section className="relative section-dark-containers pt-32 pb-20 overflow-hidden">
        ...
        <div ref={hero.ref} className="relative max-w-7xl mx-auto px-5 sm:px-8">
          <div className={`max-w-2xl transition-all duration-700 ${hero.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="text-accent-400 text-sm font-semibold tracking-widest uppercase mb-4">Ladijski kontejnerji</p>
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4 leading-tight">
              Ladijski kontejnerji
            </h1>
            <p className="text-steel-400 text-lg leading-relaxed max-w-lg">
              Trpežni, varni in vsestranski ladijski kontejnerji. Certificirana kakovost in hitra dostava po Sloveniji.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 transition-all duration-700 ${features.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="section-dark p-10 rounded-2xl text-white relative overflow-hidden">
              ...
              <div className="relative">
                <h2 className="text-2xl font-bold mb-8">Zakaj naši ladijski kontejnerji?</h2>
...
export default LadijskiKontejnerjiPage;
